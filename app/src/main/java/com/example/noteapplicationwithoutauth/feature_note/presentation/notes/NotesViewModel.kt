...
import com.example.noteapplicationwithoutauth.feature_note.domain.usecase.NotesUsecases
import com.example.noteapplicationwithoutauth.feature_note.domain.util.NoteOrder
import com.example.noteapplicationwithoutauth.feature_note.domain.util.OrderType
...
class NotesViewModel @Inject constructor(
    ...
    private val  getNoteJob: Job?= null
        ...
        when(event) {
            ...
            is NotesEvent.DeleteNote->{
                viewModelScope.launch {
                    notesUsecase.deleteNodeUseCase(event.note)
